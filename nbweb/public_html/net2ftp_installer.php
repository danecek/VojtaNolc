...
elseif ($_GET["security_code"] != "p7ptf800rejse98lqk6g" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_8jzf8";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=p7ptf800rejse98lqk6g" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="ftp.vojtanolc.cz"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="vojtanolc.cz"></td></tr>
